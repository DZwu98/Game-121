...
public class WikipediaGameImplTest {
	...
	public void testNullType(){
		try{
			WikipediaGameImpl<WikiNode> w = new WikipediaGameImpl<WikiNode>(G1);
			w.solveWikiGame(null, a1, a2);
	...
	public void testNullSrc(){
		try{
			WikipediaGameImpl<WikiNode> w = new WikipediaGameImpl<WikiNode>(G1);
			w.solveWikiGame(EdgeWeightType.UNWEIGHTED, null, a2);
			fail("no exceptions thrown");
		}catch(IllegalArgumentException e){
	...
	@Test
	public void testNullTgt(){
		try{
			WikipediaGameImpl<WikiNode> w = new WikipediaGameImpl<WikiNode>(G1);
			w.solveWikiGame(EdgeWeightType.DEGREE, a1, null);
			fail("no exceptions thrown");
		}catch(IllegalArgumentException e){
	...
	public void testSimple() {
		...
		degree.add(a1);
		degree.add(a2);
		assertEquals(degree, w.solveWikiGame(EdgeWeightType.DEGREE, a1, a2));
	}
